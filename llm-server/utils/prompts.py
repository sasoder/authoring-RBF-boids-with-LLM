...
def construct_prompt(request: GenerateRequest) -> str:
    ...
    6. You must generate at least 6 DIFFERENT vectors that are evenly spaced out across the scene, to ensure that the flow field generated is dense and reliable.
